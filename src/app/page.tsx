      ...
      <main className="bg-white">
        <nav
            ...
            <div className="flex items-center justify-between sm:justify-around gap-x-2 text-white">
                ...
                <button className="sm:hidden cursor-point flex flex-col justify-center gap-y-1" id="hamburger" aria-label="menu">
            ...
            <ul
                className="hidden sm:flex text-gray-400 justify-end items-center gap-x-7 gap-y-5 tracking-wide mt-5 sm:mt-0" id="links">
